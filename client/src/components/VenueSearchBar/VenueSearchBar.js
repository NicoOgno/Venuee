...
export default function VenueSearchBar() {
  return (
    <div className={SearchBarStyle.venueSearchBarContainer}>
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns} className={SearchBarStyle.datePicker}>
        <DesktopDatePicker
      ...
      <TextField className={SearchBarStyle.venueCapacity} label="*VENUE CAPACITY" />
